 ...
 *  8. Uzdevums
 *
 * Dots masīvs A[n][n], kurš aizpildīta ar nejaušiem skaitļiem 
 * intervālā [-5;5], n ievada lietotājs. Aprēķināt 
 * to elementu summu, kas atrodas zem galvenās diagonāles.
 */
